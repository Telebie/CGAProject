...
/*** Repräsentiert die Box in dem die Schatten dargestellt werden in dem die Kamera ist ***/
...
public class ShadowBox {
	...
	private static final float SHADOW_DISTANCE = 100;						//Reichweite der Sicht - Je höher desto weiter werden Schatten dargestellt, aber auch pixeliger

	private float minX, maxX;			// Position und Groesse der Box
	...
	protected void update() {	//jeder Frame
