...
public class ShadowFrameBuffer {
	...
	private static int createDepthBufferAttachment(int width, int height) {		//Wir brauchen keinen Color Buffer, nur den DepthBuffer um die ShadowMap zu erstellen
